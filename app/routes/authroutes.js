...
module.exports = function(app, passport) {
  ...
  app.get('/', function(req, res) {
    console.log(isLoggedInBool(req));
    if (isLoggedInBool(req))
      res.redirect('/messages');
    else
      res.render('static/landing.ejs', {"message":""});
  });
  ...
  app.post('/signup', function(req, res, next) {console.log("wwwwwwwwwwwwwwwwwwwwwwwwwwwwwww"), next();}, passport.authenticate('local-signup', {
